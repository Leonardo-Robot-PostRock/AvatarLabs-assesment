...
export default function ReviewPage() {
  ...
  const supabaseRef = useRef<ReturnType<typeof createClientSide> | null>(null)
                ...
                <CardContent className="p-6 text-center">
                  {content.status === 'approved' ? (
                    <>
                      ...
                      <p className="text-muted-foreground">This content has been approved</p>
                    </>
                  ) : (
                    <>
                      ...
                      {content.feedback && (
                        <div className="mt-4 text-left p-4 bg-black/20 rounded-lg">
                          <p className="text-sm font-medium mb-1">Feedback:</p>
                          <p className="text-sm">{content.feedback}</p>
                        </div>
                      )}
                    </>
                  )}
